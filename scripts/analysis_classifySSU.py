...
maxE = snakemake.config["ssuMaxEvalue"]
topPerc = snakemake.config["ssuTopPercent"]
minIdent = snakemake.config["ssuMinIdentity"]
minCov = snakemake.config["ssuMinCoverage"]
stringency = snakemake.config["ssuLcaStringency"]
